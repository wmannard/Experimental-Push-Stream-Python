...
def main():
    sourceId = 'haringtestoe8yk3hh-smzrppwn7b3sibo22aoqn6cana'
    orgId = 'haringtestoe8yk3hh'
    apiKey = 'xx317a6044-b2c7-4338-a78a-df1fc1eb68e3'
    ...
    print ("Old id's removed, update security cache")
    input ("Press a key to continue...")

    #Create a document
    mydoc = Document('https://myreference&id=TESTMESECURITY')
    #Set the content, this will also be available as quickview
    ...
    # identities: alex,anne,wim,peter
    ...
    print ("Now update security cache.")
    print ("Check:")
